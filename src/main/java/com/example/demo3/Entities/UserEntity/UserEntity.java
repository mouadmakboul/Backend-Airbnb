...
public class UserEntity {
    ...
    private List<CommentaireEntity> commentaires = new ArrayList<>(); // Initialisez la liste par défaut
    @OneToMany(mappedBy = "user", fetch = FetchType.LAZY)
    private List<AccountEntity> Accounts = new ArrayList<>(); // Initialisez la liste par défaut
    @OneToMany(mappedBy = "user", fetch = FetchType.LAZY)
    private List<LogementEntity> logements = new ArrayList<>(); // Initialisez la liste par défaut
    @OneToMany(mappedBy = "user", fetch = FetchType.LAZY)
    private List<PayementEntity> payement = new ArrayList<>(); // Initialisez la liste par défaut
    @OneToMany(mappedBy = "user", fetch = FetchType.LAZY)
    private List<ReservationEntity> reservation = new ArrayList<>(); // Initialisez la liste par défaut
    ...
    private Set<Role> roles = new HashSet<>(); // Initialisez l'ensemble par défaut
